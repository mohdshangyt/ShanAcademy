          ...
          <div className='flex items-center justify-between flex-wrap'>
            ...
            <div className='flex md:flex-row flex-col items-center gap-3'>
              ...
              <label htmlFor='thumbnailImage' className='flex items-center gap-3'>
                <img src= {file_upload_icon} alt='' className='p-3 bg-blue-500 rounded' />
              ...
              <div className='bg-white border rounded-lg mb-4' key={chapterIndex}>
                <div className='flex justify-between items-center p-4 border-b'>
                  <div className='flex items-center'>
                      <img src={dropdown_icon} width={14} alt=''
                      className= {`mr-2 cursor-pointer transition-all ${chapter.collapsed && "-rotate-90"}`}
                      onClick={()=> handleChapter('toggle', chapter.chapterId)}/>
                      <span className='font-semibold'> {chapterIndex+1} {chapter.chapterTitle} </span>
                  </div>
                  <span className='text-gray-500'> {chapter.chapterContent.length} Lectures </span>
                  <img src= {cross_icon} alt='' className='cursor-pointer' onClick={()=> handleChapter('remove', 
                    chapter.chapterId
                  )} />
            ...
            {showPopup && (
              <div className='fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50'>
                ...
                max-w-80'>
                  ...
                  onClick={addLecture} 
                  >Add</button>
                  <img onClick={()=> setshowPopup(false)} src={cross_icon} className='absolute top-4 right-4 w-4 cursor-pointer' alt=''/>
                  </div>
