...
const MyEnrollments = () => {
  ...
  return (
    <>
    <div className='relative w-full min-h-screen bg-gradient-to-b  from-green-200 via-sky-100 to-white'>
  
     <div className='md:px-36 x-8 pt-10'>
              ...
              <tr key={index} className='border-b border-gray-500/20'>
                ...
                space-x-3'>
                  ...
                  <div className='flex-1'>
                    ...
                    (progressArray[index].lectureCompleted*100) / progressArray[index].totalLectures : 0}  className='bg-gray-200 rounded-full' />
                  </div>
                </td>
...
export  {MyEnrollments as default};